...
- [d] Split CI-action idempotency coverage into [[wa.task.2026.2026-05-21_0820-ci-idempotency-tests]]. Keep `remove-prepare` focused on removing the bespoke command and decomposing its behavior into generic operations.
