...
- [ ] `src/core/weave/mesh_inventory_renderers.ts`: remove or gate the Alice-specific legacy fallback fragments. Directionally right and belongs with [[wa.completed.2026.2026-05-22_2308-fixture-helper-generalization]] because changing it now would alter legacy fixture-preservation output.
