...
13. Implemented thirteenth executable slice: [[wa.completed.2026.2026-05-22_2222-core-weave-html-page-renderer-extraction]] moved legacy/core HTML page renderers into a focused module.
14. Implemented fourteenth executable slice: [[wa.completed.2026.2026-05-22_2239-source-registry-extraction-source-helper-extraction]] moved source-registry ExtractionSource block helpers into a focused module.
15. Implemented fifteenth executable slice: [[wa.task.2026.2026-05-22_2248-core-weave-progression-resolver-extraction]] moved page-definition, KnopInventory, and MeshInventory progression resolvers into a focused module.
16. Later likely work: [[wa.task.2026.2026-05-22_2253-resourcepage-config-and-templating]] and legacy fixture-sensitive renderer replacement after the move-only phase. The remaining `weave.ts` helpers are mostly branch orchestration plus tiny guards.
...
- [x] The thirteenth extraction slice should be legacy HTML page renderer extraction, tracked separately in [[wa.completed.2026.2026-05-22_2222-core-weave-html-page-renderer-extraction]].
- [x] The fourteenth extraction slice should be source-registry ExtractionSource helper extraction, tracked separately in [[wa.completed.2026.2026-05-22_2239-source-registry-extraction-source-helper-extraction]].
- [x] The fifteenth extraction slice should be progression resolver extraction, tracked separately in [[wa.task.2026.2026-05-22_2248-core-weave-progression-resolver-extraction]].
...
- [x] Use [[wa.completed.2026.2026-05-22_2222-core-weave-html-page-renderer-extraction]] for the thirteenth legacy HTML page renderer extraction slice.
- [x] Extract legacy/core HTML page renderers.
- [x] Use [[wa.completed.2026.2026-05-22_2239-source-registry-extraction-source-helper-extraction]] for the fourteenth source-registry ExtractionSource helper extraction slice.
- [x] Extract source-registry ExtractionSource block helpers.
- [x] Use [[wa.task.2026.2026-05-22_2248-core-weave-progression-resolver-extraction]] for the fifteenth progression resolver extraction slice.
- [x] Extract page-definition, KnopInventory, and MeshInventory progression resolver helpers.
