...
- Fold the actionable decisions from [[ont.task.2026.2026-03-23-config-modernization]], [[wa.completed.2026.2026-04-08_1735-page-definition-ontology-and-config]], [[wa.completed.2026.2026-04-11_1723-operational-config-for-runtime-resolution]], and [[wa.completed.2026.2026-05-05-optional-history-and-slim-support-artifacts-by-default]] into a coherent next task.
...
- [x] Wire history policy into the first slim-support-artifact bridge slice from [[wa.completed.2026.2026-05-05-optional-history-and-slim-support-artifacts-by-default]]: `_knop/_meta` is current-only in first Knop and first payload weave planning, while payload and inventory histories remain unchanged.
...
- [ ] Keep path/URL trust policy integration aligned with [[wa.completed.2026.2026-04-11_1723-operational-config-for-runtime-resolution]].
